...
public final class RetrofitS  {
    ...
    private static final String URL_IMAGES = "http://192.168.43.201:84/Resim/";
    ...
    public static  int getCallPushPost(Call<StandartPostCB> call , final ProgressDialog progressDialog, final Context context,final  Boolean SuccesToast) { // 0 ve 1 dönüşler için
